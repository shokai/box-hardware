...
export LoadConfig_box_slave
export _LoadConfig_box_slave
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_box_slave
	lcall	LoadConfigTBL_box_slave_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration box_slave
;
;    Load configuration registers for box_slave.
...
;               CUR_PP
;
_LoadConfig_box_slave:
 LoadConfig_box_slave:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_box_slave_Bank0
    mov     X, <LoadConfigTBL_box_slave_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_box_slave_Bank1
    mov     X, <LoadConfigTBL_box_slave_Bank1
